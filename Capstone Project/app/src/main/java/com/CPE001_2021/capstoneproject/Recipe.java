...
public class Recipe {
    ...
    public float recipeScore; // will obtain value along with recipe_scrIngredient_scores.
    public String recipe_scrIngredient_scores; // holds the scores from each recipe ingredient // will obtain value along with recipeScore.
    public Recipe(){}
